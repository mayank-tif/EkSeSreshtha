...
class Student(models.Model):
    ...
    profile_image = models.CharField(db_column="ProfileImage", max_length=500, null=True, blank=True)
    profile_image_url = models.CharField(db_column="ProfileImageUrl", max_length=500, null=True, blank=True)
