...
urlpatterns = [
    ...
    path("User/LoginUser", LoginAPIView.as_view(), name="login"),
    ...
    path('Center/GetAllCenters/', CenterGetallcentersGetView.as_view(), name='center-getallcenters-get'),
    path('Center/GetAllCentersByStatus/', CenterGetallcentersbystatusGetView.as_view(), name='center-getallcentersbystatus-get'),
    ...
    path('User/SaveSuperAdmin/', UserSavesuperadminPostView.as_view(), name='user-savesuperadmin-post'),
    path('User/UpdateDeviceId/', UserUpdatedeviceidPostView.as_view(), name='user-updatedeviceid-post'),
    path('User/SaveUser/', UserSaveuserPostView.as_view(), name='user-saveuser-post'),
    path('User/UpdateSuperAdminUser/', UserUpdatesuperadminuserPostView.as_view(), name='user-updatesuperadminuser-post'),
    path('User/GetUserById/', UserGetuserbyidGetView.as_view(), name='user-getuserbyid-get'),
    path('User/GetUserDetailByPhoneNumber/', UserGetuserdetailbyphonenumberGetView.as_view(), name='user-getuserdetailbyphonenumber-get'),
    path('User/UpdatePassword/', UserUpdatepasswordGetView.as_view(), name='user-updatepassword-get'),
    path('User/GetAllTeachers/', UserGetallteachersGetView.as_view(), name='user-getallteachers-get'),
    path('User/GetAllUnAssignedTeacher/', UserGetallunassignedteacherGetView.as_view(), name='user-getallunassignedteacher-get'),
    path('User/GetAllRegionalAdmins/', UserGetallregionaladminsGetView.as_view(), name='user-getallregionaladmins-get'),
    path('User/SearchData/', UserSearchdataGetView.as_view(), name='user-searchdata-get'),
